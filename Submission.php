...
if(isset($_POST['personal']))
{
    ...
    $email=$_POST['email'];
    $payment=$_POST['gridRadios'];
    $country=$_POST['country'];
    $personalinfo="NAME:".$fname."<br>Email:".$email."<br>PAYMENT:".$payment."<br>COUNTRY:".$country."<br>";
    $allinfo=$_SESSION["alldata"];
    $sendall=$personalinfo.$allinfo;
    mail("admin@lotterybaby.com","My subject",$sendall);
    mail($email,"Submitted Order",$sendall);
    
    ?>
    <div class="container ">
  <div class="p-3 mb-2 bg-primary text-white">
    <h1 class="p-3 mb-2 bg-primary text-white">Your Order Has been submitted.</h1>      
    <p >All details has been sent to your registered email, please keep patiance till result annountment.</p>
  </div>
    ...
    <div class="container ">
  <div class="p-3 mb-2 bg-primary text-white">
    <h1 class="p-3 mb-2 bg-primary text-white">Select details carefuly again, its seems you have not selected details as per instructions.</h1>      
    <p ></p>
  </div>
...
// send email
 ...
 ?>
<a href="index.php"><button type="button" class="btn btn-primary">GotohomePage</button></a>
                    </div>
                </div>
                <div class="row">
